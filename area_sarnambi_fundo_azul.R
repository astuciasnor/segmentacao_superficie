...
# Carregando imagens ------------------------------------------------------
  ...
  im <- readImage("images/area_sarnambi_fundo-azul/imagem.jpg")
  plot(im)
  ref <- readImage("images/area_sarnambi_fundo-azul/Referencia.jpg")
  plot(ref)
  fundo <- readImage("images/area_sarnambi_fundo-azul/fundo_sarnambi.jpg")
  plot(fundo)
  sarnambi <- readImage("images/area_sarnambi_fundo-azul/sarnambi.jpg")
  plot(sarnambi)
...
# Objeto de referencia (cartão vermelho): 46.75 cm²
  AreaCor <- Area*19.00/NumPixelRef
